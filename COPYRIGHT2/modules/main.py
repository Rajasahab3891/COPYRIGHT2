...
start_txt = """<b> 🤖 Eᴅɪᴛ ᴍsɢ sᴇᴄᴜʀɪᴛʏ ʙᴏᴛ 🔐 </b>

𝖶𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 𝐏𝐚𝐧𝐝𝐚 𝐞𝐝𝐢𝐭 𝐦𝐬𝐠 𝐛𝐨𝐭, 𝗒𝗈𝗎𝗋 𝗏𝗂𝗀𝗂𝗅𝖺𝗇𝗍 𝗀𝗎𝖺𝗋𝖾𝗂𝗇 𝗂𝗇 𝗍𝗁𝗂𝗌 𝖳𝖾𝗅𝖾𝗀𝗋𝖺𝗆 𝗌𝗉𝖺𝖼𝖾! 𝖮𝗎𝗋 𝗆𝗂𝗌𝗌𝗂𝗈𝗇 𝗂𝗌 𝗍𝗈 𝖾𝗇𝗌𝗎𝗋𝖾 𝖺 𝗌𝖾𝖼𝗎𝗋𝖾 𝖺𝗇𝖽 𝗉𝗅𝖾𝖺𝗌𝖺𝗇𝗍 𝖾𝗇𝗏𝗂𝗋𝗈𝗇𝗆𝖾𝗇𝗍 𝖿𝗈𝗋 𝖾𝗏𝖾𝗋𝗒𝗈𝗇𝖾. 𝖥𝗋𝗈𝗆 𝖼𝗈𝗉𝗒𝗋𝗂𝗀𝗁𝗍 𝗉𝗋𝗈𝗍𝖾𝖼𝗍𝂢𝗂𝗈𝗇 𝗍𝗈 𝗆𝖺𝗂𝗇𝗍𝖺𝗂𝗇𝗂𝗇𝗀 𝖽𝖾𝖼𝗈𝗋𝗎𝗆, 𝗐𝖾'𝗏𝖾 𝗀𝗈𝗍 𝗂𝗍 𝖼𝗈𝗏𝖾𝗋𝖾𝖽.
...
gd_buttons = [              
        [
            ...
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/PANDALOVEBABY"),    
        ]
        ]
...
# -------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------
@app.on_edited_message(group & ~filters.me)
...
@app.on_message(group & filters.private & delete_long_messages)
...
@app.on_message(group & filters.document)
